 ...
 *       &lt;attribute name="groupRef" type="{http://www.w3.org/2001/XMLSchema}IDREFS" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class User {
    ...
    protected List<Object> groupRef;
     ...
     * 
     */
    public List<Object> getGroupRef() {
        if (groupRef == null) {
            groupRef = new ArrayList<Object>();
        }
